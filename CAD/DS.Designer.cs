    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Producto] WHERE (([IDProducto] = @Original_IDProducto) AND ([P" +
                "recio] = @Original_Precio) AND ((@IsNull_Stock = 1 AND [Stock] IS NULL) OR ([Sto" +
                "ck] = @Original_Stock)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Descripcion] = @Descripcion, [Precio] = @Precio, [Stock] = @Stock WHERE (([IDProducto] = @Original_IDProducto) AND ([Precio] = @Original_Precio) AND ((@IsNull_Stock = 1 AND [Stock] IS NULL) OR ([Stock] = @Original_Stock)));
SELECT IDProducto, Descripcion, Precio, Stock FROM Producto WHERE (IDProducto = @IDProducto)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CAD.Properties.Settings.Default.PrismaConnectionString;
        }
        ...
        public virtual int Delete(int Original_IDProducto, decimal Original_Precio, global::System.Nullable<double> Original_Stock) {
        ...
        public virtual int Insert(string Descripcion, decimal Precio, global::System.Nullable<double> Stock) {
            if ((Descripcion == null)) {
        ...
        public virtual int Update(string Descripcion, decimal Precio, global::System.Nullable<double> Stock, int Original_IDProducto, decimal Original_Precio, global::System.Nullable<double> Original_Stock, int IDProducto) {
            if ((Descripcion == null)) {
                throw new global::System.ArgumentNullException("Descripcion");
            }
            else {
            ...
            if ((Original_Stock.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((double)(Original_Stock.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Descripcion, decimal Precio, global::System.Nullable<double> Stock, int Original_IDProducto, decimal Original_Precio, global::System.Nullable<double> Original_Stock) {
